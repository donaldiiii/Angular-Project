...
export class AuthService {
    ...
    signup(email: string, password: string) {
        const url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCkDIkUbx6pBwPZlMvczEZzskVtZoPSfv8';
    ...
    login(email: string, password: string) {
        const url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCkDIkUbx6pBwPZlMvczEZzskVtZoPSfv8';
        return this.http.post<AuthResponseData>(url,
            {
                email,
                password,
